...
const addEmojiPickerStyles = () => {
	...
	style.textContent = `emoji-picker{position:absolute;bottom:60px;left:22px;z-index:5;display:none;opacity:0;transform:translateY(-10px) scale(0.95);transition:opacity 0.3s ease,transform 0.3s ease}emoji-picker.show{opacity:1;transform:translateY(0) scale(1)}`;
