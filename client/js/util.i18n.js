...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'settings.websocket_protocol': 'WebSocket Protocol',
			...
			'action.share_copied': 'Token copied!',
			'action.copy_failed': 'Copy failed, text:',
			'action.copy_token_failed': 'Copy failed, token:',
			...
			'security.modal_title': 'Security Check',
			'security.verify_master_title': 'Verify Server Master Key',
			'security.verify_master_message': 'The server sent a new master key for {domain}. Verify this fingerprint with other users before trusting it.',
			'security.trust_key': 'Trust key',
			'security.do_not_trust': 'Do not trust',
			'security.connection_blocked_title': 'Connection blocked',
			'security.connection_blocked_untrusted': 'Connection stopped. Without trusting the server master key, MITM protection cannot be guaranteed.',
			'security.connection_blocked_mismatch': 'Connection stopped because the server master key does not match your trusted key.',
			'security.master_changed_title': 'Master key changed',
			'security.master_changed_message': 'Warning: the trusted master key for {domain} changed. This can indicate server rotation or a potential MITM attack.',
			'security.fingerprint_old': 'Old fingerprint',
	...
	zh: {
		...
		translations: {
			...
			'settings.websocket_protocol': 'WebSocket 协议',
			'settings.chinese': '中文',
			'settings.english': 'English',
			'settings.chat': '聊天设置',
			...
			'action.share_copied': '令牌已复制！',
			'action.copy_failed': '复制失败，文本：',
			'action.copy_token_failed': '复制失败，令牌：',
			...
			'security.modal_title': '安全校验',
			'security.verify_master_title': '验证服务器主密钥',
			'security.verify_master_message': '服务器为 {domain} 发送了新的主密钥。请先与其他用户核对指纹，再决定是否信任。',
			'security.trust_key': '信任该密钥',
			'security.do_not_trust': '不信任',
			'security.connection_blocked_title': '连接已阻止',
			'security.connection_blocked_untrusted': '连接已停止。未信任服务器主密钥时，无法保证对 MITM 的防护。',
			'security.connection_blocked_mismatch': '连接已停止：服务器主密钥与您已信任的密钥不一致。',
			'security.master_changed_title': '主密钥已变化',
			'security.master_changed_message': '警告：{domain} 的已信任主密钥发生变化。这可能是服务器轮换，也可能是潜在 MITM 攻击。',
			'security.fingerprint_old': '旧指纹',
